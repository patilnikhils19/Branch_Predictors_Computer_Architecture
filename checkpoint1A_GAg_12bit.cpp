...
bool BTB_prediction(ADDRINT ins_ptr)
{
    ...
    counter = (BTB_History & mask);

   // counter = counter & mask;
    //cout << "c:" << counter << endl;
    if(BTB_Table[counter] > 1)
        {return 1;}
    else
        {return 0;}
...
//    id = id & 0xFF;
    ...
    BTB_History = (id << 1) | taken;
    BTB_History = BTB_History & mask;
  //    cout << "history: "  << BTB_History << endl;
}
